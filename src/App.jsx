                        ...
                        <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 pt-6 flex flex-col gap-6 h-full">
                            <header className="relative z-[60] flex flex-col gap-4">
                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                    ...
                                    <button onClick={() => updateUi('showGuides', !uiState.showGuides)} className={`flex items-center gap-2 px-4 py-2 rounded-xl border text-[10px] font-black uppercase transition-colors tracking-widest ${uiState.showGuides ? 'bg-[#020617] border-cyan-500/50 text-cyan-400 shadow-[inset_0_0_15px_rgba(6,182,212,0.3)]' : 'glass-panel text-slate-400'}`}><HelpCircle size={14}/> Guía</button>
                                </div>
                                <AdCarousel ads={leagueSettings.ads} />
                            </header>
                            ...
                            {uiState.view === 'dashboard' && (
                                <div className="flex flex-col gap-6 animate-fade-in">
                                    <div className="grid grid-cols-3 gap-4">
                                        <div className="glass-panel rounded-3xl p-5 flex flex-col items-center justify-center relative overflow-hidden group border border-cyan-500/20">
                                            <CalendarDays size={60} className="absolute -right-4 -bottom-4 opacity-5 group-hover:scale-110 transition-transform duration-500 text-cyan-500" />
                                        ...
                                        <div className="glass-panel rounded-3xl p-5 flex flex-col items-center justify-center relative overflow-hidden group border border-emerald-500/20">
                                            <Calendar size={60} className="absolute -right-4 -bottom-4 opacity-5 group-hover:scale-110 transition-transform duration-500 text-emerald-500" />
                                        ...
                                        <div className="glass-panel rounded-3xl p-5 flex flex-col items-center justify-center relative overflow-hidden group border border-magenta-500/20">
                                            <Activity size={60} className="absolute -right-4 -bottom-4 opacity-5 group-hover:scale-110 transition-transform duration-500 text-magenta-500" />
                                    ...
                                    <section className="glass-panel rounded-3xl p-5 md:p-6 shadow-[0_15px_40px_rgba(0,0,0,0.6)] relative overflow-hidden border border-cyan-500/30">
                                        ...
                                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-5 pb-4 border-b border-cyan-500/20 gap-4 relative z-10">
                                            ...
                                            {jornadaSummary.length > 0 && (
                                                <div className="flex gap-3">
                                                    <button onClick={() => updateUi('modal', 'jornada')} className="text-[10px] text-slate-300 hover:text-cyan-400 bg-[#020617] px-4 py-2 rounded-xl border border-cyan-500/30 uppercase tracking-widest active:scale-95 transition-all"><Edit3 size={14} className="inline mr-1.5"/> Revisar Buffer</button>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pb-2 relative z-10">
                                            {liveMatches.length === 0 && <div className="col-span-full py-10 text-slate-500 text-center border border-dashed border-cyan-500/20 rounded-2xl font-jetbrains uppercase tracking-widest text-xs">Sin señales de partidos.</div>}
                                            {[...liveMatches].sort((a, b) => (a.status === 'live' ? -1 : 1) - (b.status === 'live' ? -1 : 1)).map(match => (
                                                <div key={match.id} className={`bg-[#020617] rounded-2xl p-5 flex flex-col gap-4 relative transition-all duration-300 border ${match.status === 'live' ? 'border-cyan-500/50 shadow-[0_0_20px_rgba(6,182,212,0.15)]' : 'border-cyan-500/20'}`}>
                                                    <div className="flex justify-between items-center bg-[#020617] rounded-xl p-2 border border-cyan-500/30 shadow-inner">
                                                        ...
                                                        {match.status === 'live' ? (
                                                            ...
                                                            <div className="flex items-center gap-1.5">
                                                                ...
                                                                <button onClick={() => cancelLiveMatchSchedule(match.id)} className="text-slate-500 hover:text-rose-400 p-1.5 rounded-lg hover:bg-rose-500/10 transition-colors"><X size={16}/></button>
                                                            </div>
                                                        )}
                                                    </div>
                                                    {match.status === 'scheduled' ? (
                                                        <div className="flex flex-col justify-center gap-4">
                                                            {editingMatchId === match.id ? (
                                                                <div className="flex flex-col gap-2 p-3 bg-[#020617] rounded-xl border border-cyan-500/20 shadow-inner">
                                                                    <select value={match.t1Id} onChange={e => updateLiveMatch(match.id, 't1Id', e.target.value)} className="bg-[#020617] p-2 rounded-lg text-[11px] text-white border border-cyan-500/20 outline-none font-outfit uppercase tracking-wider">{allSortedTeams.map(t => <option key={t.id} value={t.id}>{t.name}</option>)}</select>
                                                                    <div className="text-center text-[10px] text-slate-500 font-black font-jetbrains">VS</div>
                                                                    <select value={match.t2Id} onChange={e => updateLiveMatch(match.id, 't2Id', e.target.value)} className="bg-[#020617] p-2 rounded-lg text-[11px] text-white border border-cyan-500/20 outline-none font-outfit uppercase tracking-wider">{allSortedTeams.map(t => <option key={t.id} value={t.id}>{t.name}</option>)}</select>
                                                                </div>
                                                            ) : (
                                                                <div className="text-sm font-black text-white text-center truncate font-outfit tracking-wider">{getTeamName(match.t1Id)} <span className="text-cyan-500/50 mx-2 text-[10px]">vs</span> {getTeamName(match.t2Id)}</div>
                                                            )}
                                                            <div className="text-center"><span className="text-[10px] font-bold text-cyan-400 bg-[#020617] border border-cyan-500/20 px-3 py-1.5 rounded-lg font-jetbrains tracking-wider shadow-inner">{match.date} a las {match.time || 'TBD'}</span></div>
                                                        ...
                                                        <div className="flex items-center justify-between gap-4 h-[110px]">
                                                            {[1, 2].map(n => (
                                                                <div key={n} className="flex-1 flex flex-col gap-3 min-w-0">
                                                                    <div className="text-center font-bold text-xs text-slate-300 truncate font-outfit tracking-wider">{getTeamName(match[`t${n}Id`])}</div>
                                                                    <div className="flex justify-between items-center gap-1 bg-[#020617] rounded-xl p-2 border border-cyan-500/20 shadow-inner">
                                                                        <button onClick={() => updateLiveMatch(match.id, `g${n}`, Math.max(0, match[`g${n}`] - 1))} className="text-slate-500 p-2 rounded-lg hover:bg-cyan-500/10 active:scale-90 transition-all"><Minus size={16}/></button>
                                                                        ...
                                                                        <button onClick={() => updateLiveMatch(match.id, `g${n}`, match[`g${n}`] + 1)} className="p-2 rounded-lg hover:bg-cyan-500/10 text-cyan-400 active:scale-90 transition-all"><Plus size={16}/></button>
                                                                    </div>
                                                                </div>
                                                            ))}
                                                        </div>
                            ...
                            {uiState.view === 'calendario' && (
                                <div className="flex flex-col gap-5 animate-fade-in">
                                    <div className="glass-panel p-5 sm:p-6 rounded-3xl gap-5 shadow-[0_15px_40px_rgba(0,0,0,0.6)] flex flex-col relative overflow-hidden border border-cyan-500/30">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-5 bg-[#020617] p-4 rounded-2xl relative z-10 border border-cyan-500/20 shadow-inner">
                                            ...
                                            <div className="flex flex-col gap-2 flex-1">
                                                ...
                                                <div className="flex gap-2">
                                                    <select value={calDate.day} onChange={e => setCalDate(p => ({...p, day: parseInt(e.target.value)}))} className="bg-[#020617] border border-cyan-500/30 text-white p-2.5 rounded-xl outline-none flex-1 font-jetbrains text-sm text-center appearance-none cursor-pointer hover:bg-cyan-500/10 shadow-inner">{Array.from({length: 31}, (_, i) => i + 1).map(d => <option key={d} value={d} className="bg-slate-900">{d}</option>)}</select>
                                                    <select value={calDate.month} onChange={e => setCalDate(p => ({...p, month: parseInt(e.target.value)}))} className="bg-[#020617] border border-cyan-500/30 text-white p-2.5 rounded-xl outline-none flex-1 font-jetbrains text-sm text-center appearance-none cursor-pointer hover:bg-cyan-500/10 shadow-inner">{MONTHS.map((m, i) => <option key={i} value={i + 1} className="bg-slate-900">{m}</option>)}</select>
                                                    <select value={calDate.year} onChange={e => setCalDate(p => ({...p, year: parseInt(e.target.value)}))} className="bg-[#020617] border border-cyan-500/30 text-white p-2.5 rounded-xl outline-none flex-1 font-jetbrains text-sm text-center appearance-none cursor-pointer hover:bg-cyan-500/10 shadow-inner">{YEARS.map(y => <option key={y} value={y} className="bg-slate-900">{y}</option>)}</select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-4 relative z-10">
                                        {calendarMatches.map(match => (
                                            <div key={match.id} className="bg-[#020617] p-5 rounded-3xl flex flex-col md:flex-row gap-5 shadow-lg border-l-4 border border-cyan-500/20 border-l-cyan-500/50 hover:border-l-cyan-400 transition-colors">
                                                <div className="flex-1 flex flex-col md:flex-row gap-4 items-center w-full">
                                                    <select value={match.t1Id} onChange={e => updateCalendarMatch(match.id, 't1Id', e.target.value)} className="w-full bg-[#020617] border border-cyan-500/30 p-3 rounded-xl text-white outline-none font-outfit uppercase tracking-wider text-xs focus:border-cyan-500 transition-colors shadow-inner"><option value="">Seleccionar Local</option>{allSortedTeams.map(t=><option key={t.id} value={t.id}>{t.name}</option>)}</select>
                                                    <span className="text-[10px] font-black text-cyan-500 font-jetbrains bg-[#020617] border border-cyan-500/20 px-2 py-1 rounded">VS</span>
                                                    <select value={match.t2Id} onChange={e => updateCalendarMatch(match.id, 't2Id', e.target.value)} className="w-full bg-[#020617] border border-cyan-500/30 p-3 rounded-xl text-white outline-none font-outfit uppercase tracking-wider text-xs focus:border-cyan-500 transition-colors shadow-inner"><option value="">Seleccionar Visita</option>{allSortedTeams.map(t=><option key={t.id} value={t.id}>{t.name}</option>)}</select>
                                                </div>
                                                <div className="flex gap-3">
                                                    <input type="date" value={match.date || leagueSettings.matchDay} onChange={e => updateCalendarMatch(match.id, 'date', e.target.value)} className="bg-[#020617] border border-cyan-500/30 text-white p-3 rounded-xl outline-none font-jetbrains text-xs focus:border-cyan-500 transition-colors shadow-inner" />
                                                    <input type="time" value={match.time || ""} onChange={e => updateCalendarMatch(match.id, 'time', e.target.value)} className="bg-[#020617] border border-cyan-500/30 text-white p-3 rounded-xl outline-none font-jetbrains text-xs focus:border-cyan-500 transition-colors shadow-inner" />
                                                    <button onClick={() => setCalendarMatches(p => p.filter(x => x.id !== match.id))} className="p-3 bg-rose-500/10 text-rose-400 rounded-xl hover:bg-rose-500/20 transition-colors border border-rose-500/30"><Trash2 size={18} /></button>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                    <div className="flex flex-col sm:flex-row gap-4 mt-2">
                                        <button onClick={() => setCalendarMatches(p => [...p, {id: Date.now(), t1Id: '', t2Id: '', date: '', time: '', analysis: null}])} className="flex-1 bg-[#020617] border border-cyan-500/30 hover:bg-cyan-500/10 text-cyan-400 font-black py-4 rounded-2xl uppercase tracking-widest text-xs transition-all active:scale-95 shadow-inner"><Plus size={16} className="inline mr-2"/> Nuevo Bloque</button>
